...
void down_then_up() {
  ...
  lc1.setRow(lc1_addr,2,B00000000);
  lc1.setRow(lc1_addr,1,B00000000);
  lc1.setRow(lc1_addr,0,B00000000);
  delay(400);
  lc1.setRow(lc1_addr,7,B00000000);
  lc1.setRow(lc1_addr,6,B00000000);
  lc1.setRow(lc1_addr,5,B00000000);
